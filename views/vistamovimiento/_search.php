...
/* @var $model app\models\VISTAMOVIMIENTOSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="vistamovimiento-search">
    ...
    <?php // echo $form->field($model, 'ID_TIPO_SOLICITUD') ?>

    <?php // echo $form->field($model, 'ID_ORGANISMO') ?>
